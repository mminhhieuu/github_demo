            ...
            <nav class="col-md-2 d-md-block bg-light sidebar">
                <div class="position-sticky">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class a class="nav-link" href="danhsachnv.php">Danh sách nhân viên</a>
                            <ul class="sub-menu">
                                <li>
                ...
                <?php
                        ...
                        if (isset($_GET["ma_nv"])) {
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                // Data validation and update the database
                                $sqli = "UPDATE nhanvien SET ho_ten = '$ho_ten', ten_dn = '$ten_dn',
                                    mat_khau = '$mat_khau', gioi_tinh = '$gioi_tinh', dien_thoai = '$dien_thoai', email = '$email', trinh_do = '$trinh_do',
                                    cccd = '$cccd', dia_chi = '$dia_chi',chuc_vu = '$chuc_vu', bo_phan = '$bo_phan', luong = '$luong' WHERE ma_nv = '$ma_nv'";
                                if (mysqli_query($conn, $sqli)) {
                                    echo "Lưu dữ liệu thành công";
                                    header("Location:../WEB_C9/chitetnv.php");
                                } else {
                                    echo "Lỗi ($sqli)" . $conn->error;
                                }
                            }
